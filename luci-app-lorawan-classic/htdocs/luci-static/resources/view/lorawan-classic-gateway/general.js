...
return view.extend({
	...
	render: function(data) {
		...
		/* General Settings */
		m = new form.Map('lora', _('General Settings'));
		...
		o.write = function(sid, value) {
			...
			uci.set('lora', sid, 'idGenIf', value);
			uci.set('lora', sid, 'routerid', path);
		}
		...
		o = s.option(form.ListValue, 'clksrc', _('Clock source'),
			_('Radio to provide clock to lora'));
		o.value('0', 'Radio 0');
		o.value('1', 'Radio 1');
		o.default = '0';

		var options = uci.sections('lora', 'rfconf');
